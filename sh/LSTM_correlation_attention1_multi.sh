cd ../
# model='LSTM_correlation_attention'
...
do
    ...
    do
        ...
        python main.py --summary $summary --model $model --lstm_n_layers $n_layers --time_window $time_window --device 0 --datapath $datapath --patience 3 --lr 0.0005 --epochs 30
    done
done
